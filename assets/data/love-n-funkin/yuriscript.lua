...
idle_xml_name = 'Yuri Idle'
left_xml_name = 'Yuri Sing Note Left'
down_xml_name = 'Yuri Sing Note Down'
up_xml_name = 'Yuri Sing Note Up'
right_xml_name = 'Yuri Sing Note Right'

left_miss_xml_name = 'Yuri Sing Note Left'   -- use as required
down_miss_xml_name = 'Yuri Sing Note DOWN'
up_miss_xml_name = 'Yuri Sing Note Up'
right_miss_xml_name = 'Yuri Sing Note Right'

left_alt_xml_name = 'Yuri Sing Note Left'     -- use as required
down_alt_xml_name = 'Yuri Sing Note DOWN'
up_alt_xml_name = 'Yuri Sing Note Up'
right_alt_xml_name = 'Yuri Sing Note Right'
...
name_of_character_xml = 'Doki_Yuri_Assets'
...
function onCreate()
    ...
    setPropertyLuaSprite(name_of_character, 'flipX', playableCharacter);
