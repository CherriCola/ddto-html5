...
left_miss_xml_name = 'Nat Sing Note Left'   -- use as required
down_miss_xml_name = 'Nat Sing Note DOWN'
up_miss_xml_name = 'Nat Sing Note Up'
right_miss_xml_name = 'Nat Sing Note Right'

left_alt_xml_name = 'Nat Sing Note Left'     -- use as required
down_alt_xml_name = 'Nat Sing Note DOWN'
up_alt_xml_name = 'Nat Sing Note Up'
right_alt_xml_name = 'Nat Sing Note Right'
...
name_of_character_xml = 'Doki_Nat_Assets'
name_of_character = 'Natsuki'
charNote = 'natsuki'
